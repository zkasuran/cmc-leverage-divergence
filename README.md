...
the loss from -8.3% to -1.4%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.49 overlay vs 0.50 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -8.3% | 41.9% | 0.50 |
| **Funding-regime overlay** | **-1.4%** | **15.3%** | **0.49** |
...
**below 0.5 (0.49 overlay vs 0.50 buy-and-hold)**, so neither shows a
