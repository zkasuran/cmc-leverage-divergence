...
the loss from -32.4% to -12.4%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.17 overlay vs 0.18 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -32.4% | 40.2% | 0.18 |
...
**below 0.5 (0.17 overlay vs 0.18 buy-and-hold)**, so neither shows a
