...
the loss from -11.2% to -3.2%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.44 overlay vs 0.47 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -11.2% | 41.9% | 0.47 |
| **Funding-regime overlay** | **-3.2%** | **15.3%** | **0.44** |
...
**below 0.5 (0.44 overlay vs 0.47 buy-and-hold)**, so neither shows a
