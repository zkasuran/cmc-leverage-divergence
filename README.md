...
the loss from -18.2% to -7.3%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.32 overlay vs 0.39 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -18.2% | 41.9% | 0.39 |
| **Funding-regime overlay** | **-7.3%** | **15.3%** | **0.32** |
...
**below 0.5 (0.32 overlay vs 0.39 buy-and-hold)**, so neither shows a
