...
the loss from -5.9% to 0.0%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.53 overlay vs 0.53 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -5.9% | 41.9% | 0.53 |
| **Funding-regime overlay** | **0.0%** | **15.3%** | **0.53** |
...
**below 0.5 (0.53 overlay vs 0.53 buy-and-hold)**, so neither shows a
