...
the loss from -6.0% to -0.0%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.53 overlay vs 0.52 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -6.0% | 41.9% | 0.52 |
...
**below 0.5 (0.53 overlay vs 0.52 buy-and-hold)**, so neither shows a
