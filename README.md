...
the loss from -14.3% to -5.0%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.38 overlay vs 0.43 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -14.3% | 41.9% | 0.43 |
| **Funding-regime overlay** | **-5.0%** | **15.3%** | **0.38** |
...
**below 0.5 (0.38 overlay vs 0.43 buy-and-hold)**, so neither shows a
