...
the loss from -37.6% to -13.0%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.15 overlay vs 0.13 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -37.6% | 41.9% | 0.13 |
| **Funding-regime overlay** | **-13.0%** | **15.3%** | **0.15** |
...
**below 0.5 (0.15 overlay vs 0.13 buy-and-hold)**, so neither shows a
