...
the loss from -25.4% to -11.6%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.18 overlay vs 0.29 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -25.4% | 41.9% | 0.29 |
| **Funding-regime overlay** | **-11.6%** | **15.3%** | **0.18** |
...
**below 0.5 (0.18 overlay vs 0.29 buy-and-hold)**, so neither shows a
