...
the loss from -7.9% to -1.2%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.50 overlay vs 0.51 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -7.9% | 41.9% | 0.51 |
| **Funding-regime overlay** | **-1.2%** | **15.3%** | **0.50** |
...
**below 0.5 (0.50 overlay vs 0.51 buy-and-hold)**, so neither shows a
