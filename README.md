...
the loss from -12.6% to -4.0%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.41 overlay vs 0.45 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -12.6% | 41.9% | 0.45 |
| **Funding-regime overlay** | **-4.0%** | **15.3%** | **0.41** |
...
**below 0.5 (0.41 overlay vs 0.45 buy-and-hold)**, so neither shows a
