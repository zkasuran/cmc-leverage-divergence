...
the loss from -21.4% to -9.3%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.25 overlay vs 0.34 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -21.4% | 41.9% | 0.34 |
| **Funding-regime overlay** | **-9.3%** | **15.3%** | **0.25** |
...
**below 0.5 (0.25 overlay vs 0.34 buy-and-hold)**, so neither shows a
