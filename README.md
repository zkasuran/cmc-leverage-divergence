...
the loss from -29.3% to -12.1%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.17 overlay vs 0.23 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -29.3% | 41.9% | 0.23 |
| **Funding-regime overlay** | **-12.1%** | **15.3%** | **0.17** |
...
**below 0.5 (0.17 overlay vs 0.23 buy-and-hold)**, so neither shows a
