...
Both probabilistic Sharpes sit below 0.5 (0.17 overlay vs 0.22 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -31.0% | 41.9% | 0.22 |
...
**below 0.5 (0.17 overlay vs 0.22 buy-and-hold)**, so neither shows a
