...
Both probabilistic Sharpes sit below 0.5 (0.17 overlay vs 0.20 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -31.4% | 41.9% | 0.20 |
...
**below 0.5 (0.17 overlay vs 0.20 buy-and-hold)**, so neither shows a
