...
the loss from -35.9% to -12.8%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.16 overlay vs 0.15 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -35.9% | 41.9% | 0.15 |
| **Funding-regime overlay** | **-12.8%** | **15.3%** | **0.16** |
...
**below 0.5 (0.16 overlay vs 0.15 buy-and-hold)**, so neither shows a
