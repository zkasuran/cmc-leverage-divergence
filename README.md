...
the loss from -13.0% to -4.2%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.40 overlay vs 0.44 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -13.0% | 41.9% | 0.44 |
| **Funding-regime overlay** | **-4.2%** | **15.3%** | **0.40** |
...
**below 0.5 (0.40 overlay vs 0.44 buy-and-hold)**, so neither shows a
