...
the loss from -11.8% to -3.5%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.43 overlay vs 0.46 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -11.8% | 41.9% | 0.46 |
| **Funding-regime overlay** | **-3.5%** | **15.3%** | **0.43** |
...
**below 0.5 (0.43 overlay vs 0.46 buy-and-hold)**, so neither shows a
