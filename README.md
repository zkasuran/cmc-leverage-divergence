...
the loss from -33.0% to -12.5%** on this short down-only window (`npm run cmc20`).
Both probabilistic Sharpes sit below 0.5 (0.16 overlay vs 0.19 buy-and-hold), so
...
|--|------:|-------------:|-------------:|
| CMC20 buy-and-hold | -33.0% | 41.9% | 0.19 |
| **Funding-regime overlay** | **-12.5%** | **15.3%** | **0.16** |
...
**below 0.5 (0.16 overlay vs 0.19 buy-and-hold)**, so neither shows a
